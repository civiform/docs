...
| Yes/No | Useful for simple binary questions where applicants need to answer yes or no. For more details, go to <a href="yes-no-questions.md">Yes/No questions</a>. |
