...
* Subscribe to email alerts for new bugs filed in the [issue tracker](https://github.com/civiform/civiform/issues). Click on "Watch/Unwatch" button on the top of the [civiform repo](https://github.com/civiform/civiform), select "Custom" and select "Issues".
