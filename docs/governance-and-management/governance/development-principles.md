...
* Once features are prioritized and PRDs have been finalized, **features are developed following the following technical standards**:
    * [Technical Contribution Guidelines](https://docs.civiform.us/contributor-guide/developer-guide/technical-contribution-guide)
    * [Testing practices & guidelines](https://docs.civiform.us/contributor-guide/developer-guide/testing)
...
* Features are announced via [Release Notes in GitHub](https://github.com/civiform/civiform/releases) and sent to civiform-technical@ and civiform-announce@. Read more about [release practices](https://docs.civiform.us/it-manual/sre-playbook/upgrading-to-a-new-release).
