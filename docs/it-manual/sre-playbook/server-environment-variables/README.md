...
available variables are documented in a
...
variables. The generated markdown files are added to this directory. Use the
...
A variable's mode is listed in between the variable name and its description in the server environment variable documentation that is generated on each release and saved in this directory (for example [v3.27.0](https://docs.civiform.us/it-manual/sre-playbook/server-environment-variables/v3.27.0)).
