...
5. Find the version that you want to deploy on https://github.com/civiform/civiform/releases
6. Run bin/setup --tag=\<version>


## Deploy

1. Find the version that you want to deploy on https://github.com/civiform/civiform/releases
