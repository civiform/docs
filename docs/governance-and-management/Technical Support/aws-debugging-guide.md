...
The CiviForm team responds that this is likely due to a configuration error where the the domain is not yet verified in SES. It will take about a day to get approved!