...
* There's a `Design & UX` Folder in the team [Google Drive](../../governance-and-management/governance/communication.md#shared-drive) that can be used to store any source assets.
