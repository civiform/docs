...
- **Description**: Limits results to applications submitted on or after the provided date, in the CiviForm instance's local time. If timezone is not provided, uses local time. If time is not provided, defaults to the beginning of the day.

#### `toDate`
- **Parameter**: An ISO-8601 formatted date and time with zoneId (i.e. YYYY-MM-DDTThh:mm:ssZ).
- **Format**: An ISO-8601 formatted date (i.e. YYYY-MM-DD).
- **Description**: Limits results to applications submitted before the provided date, in the CiviForm instance's local time.  If timezone is not provided, uses local time. If time is not provided, defaults to the beginning of the day.
